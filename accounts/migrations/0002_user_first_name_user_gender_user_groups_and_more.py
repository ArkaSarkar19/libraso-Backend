...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='gender',
            field=models.CharField(choices=[('M', 'Male'), ('F', 'Short'), ('O', 'Other')], default='F', max_length=2),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='user_type',
            field=models.CharField(choices=[('AD', 'Admin'), ('PR', 'PROFESSOR'), ('ST', 'STUDENT')], default='ST', max_length=2),
        ),
        migrations.AddField(
            model_name='user',
            name='username',
